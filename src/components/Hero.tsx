            ...
            <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-2 relative z-10 order-1 lg:order-1">
                ...
                <div className="max-w-2xl space-y-3">
                  <Button type="button" variant="default" size="lg" onClick={() => setShowManualEntry(true)} className="h-16 md:h-16 px-8 text-lg md:text-lg font-semibold bg-foreground text-background hover:bg-foreground/90 rounded-xl w-full sm:w-auto touch-manipulation">
