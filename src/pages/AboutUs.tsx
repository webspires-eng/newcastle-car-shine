      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="rounded-3xl overflow-hidden shadow-xl">
                <img src={dealershipImg} alt="Our dealership" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-card p-8 rounded-2xl">
                  ...
                  <p className="text-muted-foreground">
                    We use advanced market data to ensure you get a fair, competitive price for your car every time.
                  </p>
                </div>
                <div className="bg-card p-8 rounded-2xl">
                  <h3 className="text-2xl font-bold text-foreground mb-4">Speed & Simplicity</h3>
                  <p className="text-muted-foreground">
                    From valuation to payment, we make the entire process fast and hassle-free. Most sales complete in under 24 hours.
                  </p>
                </div>
                <div className="bg-card p-8 rounded-2xl">
                  <h3 className="text-2xl font-bold text-foreground mb-4">Trust & Transparency</h3>
                  <p className="text-muted-foreground">
                    No hidden fees, no surprises. What we offer is what you get, with full transparency throughout.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
              <div className="rounded-3xl overflow-hidden shadow-xl">
                <img src={carHandshakeImg} alt="Happy customer" className="w-full h-full object-cover" />
              </div>
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <p className="text-lg text-muted-foreground">Free, instant online valuation with no obligation</p>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-hero-yellow flex items-center justify-center flex-shrink-0 mt-1">
                      <span className="text-foreground font-bold">✓</span>
                    </div>
                    <p className="text-lg text-muted-foreground">Same-day payment via bank transfer</p>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-hero-yellow flex items-center justify-center flex-shrink-0 mt-1">
                      <span className="text-foreground font-bold">✓</span>
                    </div>
                    <p className="text-lg text-muted-foreground">Free collection from your home or workplace</p>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-hero-yellow flex items-center justify-center flex-shrink-0 mt-1">
                      <span className="text-foreground font-bold">✓</span>
                    </div>
                    <p className="text-lg text-muted-foreground">We handle all the paperwork, including DVLA notifications</p>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-hero-yellow flex items-center justify-center flex-shrink-0 mt-1">
                      <span className="text-foreground font-bold">✓</span>
                    </div>
                    <p className="text-lg text-muted-foreground">Outstanding customer service rated 4.8/5</p>
                  </li>
                </ul>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-foreground/80 mb-8">
                Join over 500,000 satisfied customers and get your free valuation today.
              </p>
